...
const setup = (secretWord = null) => {
  ...
  // use moune, because useEffect not callend on `shallow`
...
describe("getSecretWord calls", () => {
  ...
  test("secretWord does not update on App update", () => {
    const wrapper = setup();
    // clear the mock as it was called once on setup
    mockGetSecretWord.mockClear();

    // wrapper.update() doesn't triigger update
    // issue on https://github.com/airbnb/enzyme/issues/2091
    wrapper.setProps();
